...
public class Role {
    ...
    //in our model class we need to directly reflect our db table
...
//all args constructor
    ...
    //all args minus id the big picture the id is serial so its generated automatically
    //if we were to create a new role we don't have to worry bout including the primary key
    ...
    //to string let us print our object in strings form (instead of memory address)
