...
public class Employee {
    ...
    /*Employee objects in Java will contain entire Role objects instead of just an int foreign key
       ...
       Role objects have all the data relevant to Role.*/
    ...
    //we'll have different constructor using one or the other FK varaible used for different purpose
   ...
   //boilerplate code--
    ...
    //all args minus id with role_fk_id only used for insert
    ...
    //this is tostring() so we can print our employee object
